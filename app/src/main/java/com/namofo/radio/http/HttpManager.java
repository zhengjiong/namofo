...
public class HttpManager {
    ...
    public void doHttp(BasePostEntity basePostEntity) {
        Observable observable = basePostEntity.getObservable(httpService)
                /*失败后的retry配置*/
...
//                .compose(basePostEntity.getRxAppCompatActivity().bindToLifecycle())
        ...
        observable.subscribe(basePostEntity.getSubscriber());
    }
